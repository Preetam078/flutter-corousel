...
class DodCardV2 extends StatefulWidget {
  final bool isActive;
...
class _DodCardState extends State<DodCardV2> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Transform.translate(
      ...
      child: GestureDetector(
        ...
        onVerticalDragEnd: widget.isActive ? null : null,
