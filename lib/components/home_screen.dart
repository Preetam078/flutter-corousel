import 'package:corousel/components/curved_carousel.dart';
import 'package:corousel/components/flying_item.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _pageController = PageController(viewportFraction: 0.6); // Adjusted for taller aspect ratio
  ...
  void _handlePullDown(CarouselItem item, double dragOffset) {
    ...
    final cardWidth = size.width * 0.7; // This might need adjustment if viewportFraction changed
