...
import 'package:corousel/components/card.dart';
import 'package:flutter/material.dart';

class CorouselBuilder extends StatefulWidget{
final List<Widget> widgets;
  ...
  CorouselBuilder({
   ...
   @override
  _CorouselBuilderState createState() => _CorouselBuilderState();

}

class _CorouselBuilderState extends State<CorouselBuilder> {
